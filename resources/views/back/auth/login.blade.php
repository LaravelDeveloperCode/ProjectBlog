                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login/Parol</h1>
                                    </div>
                                    <form method="post" action="{{route('loginsertt')}}">
                                        @csrf
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Daxil ol</button>
                                    </form>
                                    <hr>
                                    <a href="{{route('registrr')}}" class="btn btn-google btn-user btn-block">Qeydiyyat</a>
                                </div>
                            </div>
                        </div>
                    </div>
